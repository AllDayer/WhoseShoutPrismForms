...
namespace WhoseShoutFormsPrism.ViewModels
{
    public class LoginPageViewModel : BaseViewModel
    {
        ...
        private async void OnLoginCommandExecuted()
        {
            ...
            {
                await _navigationService.NavigateAsync("/MainPage/NavigationPage/SummaryPage?message=Welcome");
            }
            else
            {
                await _pageDialogService.DisplayAlertAsync("Wrong", "Hi", "I didn't read the code...");
            }
            IsBusy = false;
        }
